...
COPY --from=builder /moreload/dist ./dist
COPY --from=builder /moreload/.next ./.next
COPY --from=builder /moreload/package.json ./package.json

COPY --from=builder /moreload/node_modules ./node_modules
COPY --from=builder /moreload/node_modules/.prisma/client ./node_modules/.prisma/client
COPY --from=builder /moreload/node_modules/@prisma/client ./node_modules/@prisma/client

# Copy Startup Script
COPY docker-entrypoint.sh /moreload
# Make Startup Script Executable
RUN chmod a+x /moreload/docker-entrypoint.sh
# Set the entrypoint to the startup script
ENTRYPOINT ["tini", "--", "/moreload/docker-entrypoint.sh"]