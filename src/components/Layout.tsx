              ...
              <Tooltip
                label={
                  version.data.local !== version.data.upstream
                    ? `You are running an outdated version of MoreLoad, refer to the docs on how to update to ${version.data.upstream}`
                    : 'You are running the latest version of MoreLoad'
                }
              >
                <Badge
                  m='md'
